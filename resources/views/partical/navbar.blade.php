            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('orders')}}"><i class="fas fa-user-check"></i> Orders</a>
                        </li>
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('post.categories')}}"><i class="fas fa-clipboard"></i>Categories</a>
                    </li>
                    @endif
